<header class="header bg-body">
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="./index.asp">
                <img class="img-fluid w-100" src="public/img/logo-mini.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="./index.asp">
                <img class="side-nav-show-on-closed" src="./public/img/core-img/logo.png" alt="Graindashboard" style="width: 3em;">
                <img class="side-nav-hide-on-closed" src="./public/img/core-img/logo.png" alt="Graindashboard">
            </a>
