...
<body>
  <div class="container-scroller"> 
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input name="password" type="password" class="form-control" id="exampleInputPassword4" required placeholder="Password" onkeyup="valPassword(this.value)">
    ...
    <script>
      ...
      // ấn submit gọi 2 hàm call 2 ajax
