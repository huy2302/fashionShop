<aside id="sidebar" class="js-custom-scroll side-nav">
        <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
            ...
            <li class="side-nav-menu-item active">
                <a class="side-nav-menu-link media align-items-center" href="./index.asp">
            ...
            <li class="side-nav-menu-item side-nav-has-menu">
                ...
                <ul id="subUsers" class="side-nav-menu side-nav-menu-second-level mb-0">
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="./users.asp">All Users</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="./user-edit.asp">Add new</a>
                    </li>
                </ul>
                <!-- End Users: subUsers -->
            </li>
            ...
            <li class="side-nav-menu-item side-nav-has-menu">
                ...
                <!-- Users: subEmployees -->
                <ul id="subEmployees" class="side-nav-menu side-nav-menu-second-level mb-0">
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="users.html">All Employees</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="user-edit.html">Add new</a>
                    </li>
                </ul>
                <!-- End Users: subEmployees -->
            </li>
            <!-- End Users -->
